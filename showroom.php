...
<section class="page-header listing_page">
  ...
  <div class="container" id="slider"><!--container slider begin-->
    <div class="col-md-12"><!-----col-md-12 begin--->
        <div class="carouselslide" id="mycarousel" data-ride="carousel"><!--carousel slide begin--->
            <ol class="carousel-indicators"> <!---carousel indivator begin-->
                <li class="active" data-target="#mycarousel" data-slide-to="0"></li>
                <li  data-target="#mycarousel" data-slide-to="1"></li>
                <li  data-target="#mycarousel" data-slide-to="2"></li>
                <li data-target="#mycarousel" data-slide-to="3"></li>
            </ol><!---carousel indivator finish-->

            <div class="carousel-inner"><!--carousel-inner begin------>

              <div class="item active">

                <img src= "images/slider image 6.jpg" alt="slider image 1">

              </div>

               <div class="item">

                <img src= "images/slider image 3.jpg" alt="slider image 2">
              </div>

              <div class="item">

              <img src= "images/slider image 4.jpg" alt="slider image 3">
              </div>
              
              <div class="item">

                <img src= "images/slider image 5.jpg" alt="slider image 4">
              </div>

                <div class="item">

                <img src= "images/slider image 6.jpg" alt="slider image 5">
               </div>
            </div><!----------carousel carousel-inner finish------>
