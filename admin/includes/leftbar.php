...
<li><a href="#"><i class="fa fa-sitemap"></i> Vehicles</a>
				...
				<li><a href="manage contactus.php"><i class="fa fa-desktop""></i> Manage Conatctus </a></li>
				<li><a href="reg-delears.php"><i class="fa fa-users"></i> Reg users</a></li>
			...
			<li><a href="manage-subscribers.php"><i class="fa fa-table"></i> Manage user info</a></li>
